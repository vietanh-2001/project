          ...
          <div class="col-lg-12 col-12">
            ...
            <div class="card card-primary">
              <div class="card-header">
                <h3 class="card-title">Phản hồi admin</h3>
              </div>
              <!-- /.card-header -->
              <!-- form start -->
              ...
              @csrf
                <div class="card-body">
                  ...
                  <div class="form-group">
                    ...
                    <input style="height:100px ;" value="{{$phanhoi->phanhoiadmin}}" type="text" class="form-control" name="phanhoiadmin" id="phanhoiadmin" placeholder="Nhập phản hồi của admin">
                  </div>
