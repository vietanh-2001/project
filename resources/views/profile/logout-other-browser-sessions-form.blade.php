<x-jet-action-section>
    <x-slot name="title" >
      <p style="font-size: 30px;color: red"> {{ __('Browser Sessions') }} </p> 
    </x-slot>

    <x-slot name="description">
        <p style="font-size: 18px;"> {{ __('Manage and log out your active sessions on other browsers and devices.') }}</p>
    </x-slot>

    <x-slot name="content">
        <div class="max-w text-sm text-gray-600 " style="font-size: 10px">
