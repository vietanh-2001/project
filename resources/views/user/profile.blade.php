                ...
                <div class="sub-header">
                    <nav>
                        ...
                        <div class="nav-link">
                            ...
                            <li class="dropdown" >
                                <a href="" class="dropdown-toggle"  data-toggle="dropdown"><span>{{ Auth::user()->name }}</span><span class="caret"></span></a>
                    ...
                    <a href="" class="btn" style="font-size: 20px">Chỉnh Sửa Profile </a>
                </div>
